...
ChoiceGate is pre-1.0. Security fixes apply only to the current 0.2.x source line; no stable release
line is supported yet. Use the latest published package shown on PyPI.
